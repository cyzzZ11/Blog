...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'cyzzZ', // 必需
      link: 'https://github.com/cyzzZ11' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:541129392@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/cyzzZ11'
        },
        // {
        //   iconClass: 'icon-erji',
        //   title: '听音乐',
        ...
        //   iconClass: 'icon-csdn',
        //   title: 'csdn',
        //   link: 'https://blog.csdn.net/cyzz'
        // },
        // {
        //   iconClass: 'icon-zhihu',
        //   title: 'zhihu',
        //   link: 'https://www.zhihu.com/people/cyz'
        // }
      ]
    },
    footer: { // 页脚信息
      createYear: 2020, // 博客创建年份
      copyrightInfo: 'cyzzZ | <a href="https://github.com/cyzzZ11" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
